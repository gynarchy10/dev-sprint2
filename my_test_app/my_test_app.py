...
class Main(flask.views.MethodView):
    def get(self):
        return flask.render_template('my_testindex.html')
...
def login_required(method):
    ...
    def wrapper(*args, **kwargs):
        if 'username' in flask.session:
            ...
            flask.flash("A login is required to see the page! Duh...")
            return flask.redirect(flask.url_for('index'))
    return wrapper
...
class Remote(flask.views.MethodView):
    @login_required
    def get(self):
        return flask.render_template('my_testremote.html')
...
class Music(flask.views.MethodView):
    ...
    def get(self):
        ...
        return flask.render_template('my_testmusic.html', songs=songs)
